...
<div class="page-inner">
            ...
            <div class="modal-content">
                <form class="form-horizontal" id="userForm" novalidate="novalidate">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group form-inline control-group">
                            ...
                            <div class="col-md-9 controls">
                                <input type="email" id="email" name="email" class="form-control input-full"
                                    placeholder="<?php echo e(translate('Email address')); ?>" required="required"
                        ...
                        <div class="form-group control-group form-inline ">
                            <label class="col-md-3">
                                <?php echo e(translate('User Name')); ?>

                                <span class="required-label">*</span>
                            </label>
                            <div class="col-md-9 controls">
                                <input type="text" id="username" name="username" placeholder="<?php echo e(translate('User name')); ?>" required
                        ...
                        <div class="form-group control-group form-inline">
                            ...
                            <div class="col-md-9 controls">
                                <input type="text" id="name" name="name" class="form-control input-full"
                                    placeholder="<?php echo e(translate('Full Name')); ?>" required
                        ...
                        <div class="div-password form-group control-group form-inline">
                            ...
                            <div class="col-md-9 controls">
                                <input type="password" name="password" id="password" placeholder="<?php echo e(translate('Password')); ?>"
                        ...
                        <div class="div-password form-group control-group form-inline">
                            ...
                            <div class="col-md-9 controls">
                                <input type="password" name="password_confirmation" id="password_confirmation"
                                    placeholder="<?php echo e(translate('Confirm Password')); ?>" class="form-control input-full" required minlength="8"
                        ...
                        <div class="form-group control-group form-inline">
                            <label class="col-md-3 col-form-label">
                                <?php echo e(translate('User Role')); ?>
                        ...
                        <div class="form-group control-group form-inline">
                            <label class="col-md-3 col-form-label">
                                <?php echo e(translate('Staff/Employee')); ?>        
                            </label>
                            <div class="col-md-9 controls">
                        ...
                        <div class="form-group control-group form-inline">
                            <label class="col-md-3 col-form-label">
                                <?php echo e(translate('User Branch')); ?>        
                            </label>
                            <div class="col-md-9 controls">
                        ...
                        <div class="form-group form-inline">
                            <label class="col-md-3 col-form-label"><?php echo e(translate('Status')); ?></label>
                            <div class="col-md-9">
                                <div class="form-check">
                                    <label class="form-radio-label">
                                        <input id="statusYes" type="radio" name="status" class="form-radio-input" value="1" checked="checked" />
                                        <span class="form-radio-sign pl-1"> <?php echo e(translate('Active')); ?></span>
                                    </label>
                                    <label class="form-radio-label">
                                        <input id="statusNo" type="radio" class="form-radio-input" name="status"
                                            value="0" />
                                        <span class="form-radio-sign pl-1"> <?php echo e(translate('Inactive')); ?></span>
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="btnSave" class="btn btn-primary btn-sm"><?php echo e(translate('Save Change')); ?></button>
            ...
            <div class="main-card card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title"> <i class="fas fa-user"></i> <?php echo e(translate('User Information')); ?> </h4>
                        <button id="btnAddUser" class="btn btn-primary btn-sm btn-round ml-auto">
                            <i class="fa fa-plus"></i> <?php echo e(translate('Add New User')); ?>
    ...
    <script src="<?php echo e(dsAsset('js/custom/user_management/user.js')); ?>"></script>
  </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/link/lp/vet/resources/views/user_management/user.blade.php ENDPATH**/ ?>