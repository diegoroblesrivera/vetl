...
<link href="<?php echo e(dsAsset('js/lib/tui.calendar/tui-calendar/dist/tui-calendar.css')); ?>" rel="stylesheet" />
<link href="<?php echo e(dsAsset('js/lib/tui.calendar/tui-time-picker/dist/tui-time-picker.min.css')); ?>" rel="stylesheet" />
<link href="<?php echo e(dsAsset('js/lib/tui.calendar/tui-date-picker/dist/tui-date-picker.min.css')); ?>" rel="stylesheet" />

<script src="<?php echo e(dsAsset('js/lib/tui.calendar/tui-code-snippet/dist/tui-code-snippet.min.js')); ?>"></script>
<script src="<?php echo e(dsAsset('js/lib/tui.calendar/tui-time-picker/dist/tui-time-picker.min.js')); ?>"></script>
<script src="<?php echo e(dsAsset('js/lib/tui.calendar/tui-date-picker/dist/tui-date-picker.min.js')); ?>"></script>
<script src="<?php echo e(dsAsset('js/lib/tui.calendar/tui-calendar/dist/tui-calendar.min.js')); ?>"></script>
<script src="<?php echo e(dsAsset('js/lib/tui.calendar/tui-calendar-init.js')); ?>"></script>

<script src="<?php echo e(dsAsset('js/lib/country-list.js')); ?>"></script>


<link href="<?php echo e(dsAsset('css/custom/employee/employee.css')); ?>" rel="stylesheet" />
<script src="<?php echo e(dsAsset('js/custom/employee/employee.js')); ?>"></script>
            ...
            <div class="modal-content">
                <form class="form-horizontal" id="inputFormOffDay" novalidate="novalidate">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">
                            <span class="fw-mediumbold">
                                <?php echo e(translate('Add or update off day')); ?>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group control-group form-inline">
                            <div class="tui-full-calendar-popup-section-item w100">
                                ...
                                <input id="holiday-title" name="title" class="tui-full-calendar-content w80" placeholder="<?php echo e(translate('Subject')); ?>" value="" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group control-group form-inline">
                                    <div class="tui-full-calendar-popup-section-item w100">
                                        ...
                                        <input id="start-date" name="start_date" class="startDate tui-full-calendar-content w80" placeholder="<?php echo e(translate('Start date')); ?>" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group control-group form-inline">
                                    <div class="tui-full-calendar-popup-section-item w100">
                                        <span class="tui-full-calendar-icon tui-full-calendar-ic-date"></span>
                                        <input id="end-date" name="end_date" class="endDate tui-full-calendar-content w80" placeholder="<?php echo e(translate('End date')); ?>" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="submit" id="btn-calendar-save" class="btn btn-success btn-sm"><?php echo e(translate('Save Change')); ?></button>
    ...
    <div class="modal fade tui-calender-modal" id="frmViewCalendarModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog tui-calendar-modal-content" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="btn-calendar-edit" class="btn btn-warning btn-sm float-left"><?php echo e(translate('Edit')); ?></button>
                    <button type="button" id="btn-calendar-delete" class="btn btn-danger btn-sm"><?php echo e(translate('Delete')); ?></button>
            ...
            <div class="modal-content">
                <form class="form-horizontal" id="inputForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">
                            <span class="fw-mediumbold">
                                <?php echo e(translate('Staff / Employee Info')); ?>
                    ...
                    <div class="modal-body">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-link active" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="true"><i class="far fa-user"></i> <?php echo e(translate('Basic Profile')); ?></a>
                                <a class="nav-link" id="nav-service-tab" data-toggle="tab" href="#nav-service" role="tab" aria-controls="nav-service" aria-selected="false"><i class="fas fa-th fa-fw"></i> <?php echo e(translate('Available Service')); ?></a>
                                <a class="nav-link" id="nav-schedule-tab" data-toggle="tab" href="#nav-schedule" role="tab" aria-controls="nav-schedule" aria-selected="false"><i class="far fa-calendar-alt"></i> <?php echo e(translate('Service Time')); ?></a>
                                <a class="nav-link" id="nav-offday-tab" data-toggle="tab" href="#nav-offday" role="tab" aria-controls="nav-offday" aria-selected="false"><i class="far fa-calendar"></i> <?php echo e(translate('Day Off')); ?></a>
                            </div>
                        </nav>
                            ...
                            <div class="tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                <div class="row">
                                    <div class="col-md-4 pl-4">
                                        <div class="form-group control-group form-inline">
                                            ...
                                            <span class="float-left w-100"><?php echo e(translate('Image')); ?> 360x260</span>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group control-group form-inline">
                                            <label class="col-md-12">
                                                <?php echo e(translate('Staff Name')); ?>

                                                <span class="required-label">*</span>
                                            </label>
                                            <div class="col-md-12 controls">
                                                <input type="text" id="full_name" name="full_name" required placeholder="<?php echo e(translate('Staff/Employee Name')); ?>" class="form-control input-full" data-validation-required-message="Staff/Employee Name is required" />
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                        <div class="form-group control-group form-inline">
                                            <label class="col-md-12">
                                                <?php echo e(translate('Staff ID')); ?> <span class="required-label">*</span>
                                            </label>
                                            <div class="col-md-12 controls">
                                                <input type="text" id="employee_id" name="employee_id" placeholder="<?php echo e(translate('Staff/Employee ID')); ?>" class="form-control input-full" />
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                        <div class="form-group control-group form-inline">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group form-inline control-group">
                                            <label class="col-md-12">
                                                <?php echo e(translate('Phone No')); ?>

                                            </label>
                                            <div class="col-md-12 controls">
                                                <div class="input-group">
                                                    <input type="text" id="contact_no" maxlength="20" placeholder="<?php echo e(translate('Phone No')); ?>" class="form-control w100" />
                                                </div>
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group control-group form-inline ">
                                            ...
                                            <div class="col-md-12 controls">
                                                <input type="email" id="email_address" name="email_address" placeholder="<?php echo e(translate('Email Address')); ?>" class="form-control input-full" required data-validation-required-message="Email is required" />
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group control-group form-inline">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <label class="col-md-12">
                                                <?php echo e(translate('Designation')); ?>
                                ...
                                <div class="form-group control-group form-inline">
                                    <div class="col-md-6">
                                        <div class="row">
                                            <label class="col-md-12">
                                                <?php echo e(translate('Salary')); ?>

                                            </label>
                                            <div class="col-md-12 controls">
                                                <input type="number" name="salary" id="salary" placeholder="<?php echo e(translate('Monthly Salary')); ?>" class="form-control input-full" value="0.00" />
                                                <span class=" help-block"></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <label class="col-md-12">
                                                <?php echo e(translate('Commission per service')); ?> %
                                            </label>
                                            <div class="col-md-12 controls">
                                                <input type="number" name="commission" id="commission" placeholder="<?php echo e(translate('Commission per service')); ?>" class="form-control input-full" value="0.00" />
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group control-group form-inline">
                                    <div class="col-md-6">
                                        <div class="row">
                                            <label class="col-md-12">
                                                <?php echo e(translate('Commission based on')); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <label class="col-md-12">
                                                <?php echo e(translate('Target service amount')); ?> 
                                            </label>
                                            <div class="col-md-12 controls">
                                                <input type="number" name="target_service_amount" id="target_service_amount" placeholder="<?php echo e(translate('service')); ?>" class="form-control input-full" value="0.00" readonly="true" />
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group control-group form-inline d-none">
                                    <label class="col-md-12">
                                        <?php echo e(translate('System User')); ?>
                                ...
                                <div class="form-group control-group form-inline ">
                                    <label class="col-md-12">
                                        <?php echo e(translate('Gender')); ?> <span class="required-label">*</span>
                                    </label>
                                    <div class="col-md-12 controls">
                                ...
                                <div class="form-group control-group form-inline ">
                                    <label class="col-md-12">
                                        <?php echo e(translate('Specialist')); ?>

                                    </label>
                                    <div class="col-md-12 controls">
                                        <textarea type="text" id="specialist" name="specialist" placeholder="<?php echo e(translate('Specialist')); ?>" class="form-control input-full"></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group control-group form-inline ">
                                    <label class="col-md-12">
                                        <?php echo e(translate('Present Address')); ?>

                                    </label>
                                    <div class="col-md-12 controls">
                                        <textarea type="text" id="present_address" name="present_address" placeholder="<?php echo e(translate('Present Address')); ?>" class="form-control input-full"></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group control-group form-inline ">
                                    <label class="col-md-12">
                                        <?php echo e(translate('Permanent Address')); ?>

                                    </label>
                                    <div class="col-md-12 controls">
                                        <textarea type="text" id="permanent_address" name="permanent_address" placeholder="<?php echo e(translate('Permanent Address')); ?>" class="form-control input-full"></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group control-group form-inline ">
                                    ...
                                    <div class="col-md-12 controls">
                                        <textarea type="text" id="note" name="note" placeholder="<?php echo e(translate('Note')); ?>" class="form-control input-full"></textarea>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group control-group form-inline ">
                                    <label class="col-md-12">
                                        <?php echo e(translate('Visibility Status')); ?>
                                    ...
                                    <table class="w100" id="tblEmployeeSchedule">
                                        <thead>
                                            <tr class="text-center">
                                                <th><?php echo e(translate('Day')); ?></th>
                                                <th><?php echo e(translate('Start Time')); ?></th>
                                                <th><?php echo e(translate('End Time')); ?></th>
                                                <th><?php echo e(translate('Break Start')); ?></th>
                                                <th><?php echo e(translate('Break End')); ?></th>
                                                <th><?php echo e(translate('Weekly Holiday')); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                            ...
                            <div class="tab-pane fade" id="nav-offday" role="tabpanel" aria-labelledby="nav-offday-tab">
                                <div class="row">
                                    <div class="col-md-12 mt-2">
                                        <div id="menu">
                                            <span id="menu-navi">
                                                <button type="button" class="btn btn-default2 btn-tui-calendar-default2 btn-sm move-today btn-round btn-move-calendar" data-action="move-today"><?php echo e(translate('Today')); ?></button>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="btnSaveEmployee" class="btn btn-success btn-sm"><?php echo e(translate('Save Change')); ?></button>
            ...
            <div class="main-card card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title">
                            <?php echo e(translate('Staff Info')); ?>

                        </h4>
                        <button id="btnAdd" class="btn btn-primary btn-sm btn-round ml-auto">
                            <i class="fa fa-plus"></i> <?php echo e(translate('Add New Staff')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/link/lp/vet/resources/views/employee/employee.blade.php ENDPATH**/ ?>