...
<div class="page-inner">
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="card">
        <div class="card-header">
          <h2><i class="fas fa-cogs"></i> <?php echo e(translate('Currency Setup')); ?></h2>
        </div>
    ...
    <div class="col-md-4">
      <div class="card">
        <div class="card-header">
          <h2><i class="far fa-money-bill-alt"></i> <?php echo e(translate('Local Payment')); ?></h2>
        </div>
            ...
            <div class="row">
              <div class="col-md-12 controls">
                <div class="form-group control-group form-inline">
                  <label class="switch">
                    <input id="enableLocalPayment" <?php echo e($paymentConfig['local_payment_status']==1?"checked":""); ?> name="enableLocalPayment" type="checkbox" value="1" class="rm-slider" />
                    <span class="slider round"></span>
                  </label>
                  <label class="pt-1 ml-1">
                    <h5><?php echo e(translate('Local Payment')); ?></h5>
                  </label>
                </div>
              </div>
            </div>
    ...
    <div class="col-md-4">
      <div class="card">
        <div class="card-header">
          <h2><i class="fab fa-paypal"></i> <?php echo e(translate('Paypal Payment')); ?></h2>
        </div>
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-12 controls">
                <div class="form-group control-group form-inline">
                  <label class="switch">
                    <input id="enablePaypalPayment" <?php echo e($paymentConfig['paypal_payment_status']==1?"checked":""); ?> name="enablePaypalPayment" type="checkbox" value="1" class="rm-slider" />
                    <span class="slider round"></span>
                  </label>
                  <label class="pt-1 ml-1">
                    <h5><?php echo e(translate('Paypal Payment')); ?></h5>
                  </label>
                </div>
              </div>
            </div>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="card">
        <div class="card-header">
          <h2><i class="fab fa-paypal"></i> <?php echo e(translate('Paypal Config')); ?></h2>
        </div>
        <form class="form-horizontal" id="inputFormPaypalConfig" novalidate="novalidate">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-12 controls">
                <div class="form-group control-group form-inline">
                  <label> <?php echo e(translate('Client ID')); ?>

                    <span class="required-label">*</span>
                  </label>
                  <input type="text" value="<?php echo e($paypalConfig['client_id']); ?>" id="client_id" name="client_id" placeholder="<?php echo e(translate('Client ID')); ?>" required class="form-control input-full" data-validation-required-message="Paypal Client ID is required" />
            ...
            <div class="row">
              <div class="col-md-12 controls">
                <div class="form-group control-group form-inline">
                  <label> <?php echo e(translate('Client Secret')); ?>

                    <span class="required-label">*</span>
                  </label>
                  <input type="text" value="<?php echo e($paypalConfig['client_secret']); ?>" id="client_secret" name="client_secret" placeholder="<?php echo e(translate('Client Secret')); ?>" required class="form-control input-full" data-validation-required-message="Paypal Client Secret is required" />
                  <span class="help-block"></span>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 controls">
                <div class="form-group control-group form-inline">
                  <label> <?php echo e(translate('Charge Type')); ?>

                  </label>
                  <select class="form-control input-full" id="charge_type" name="charge_type">
                  <option <?php echo e($paypalConfig['charge_type']==1?"selected ":""); ?> value="1">Addition</option>
                    <option <?php echo e($paypalConfig['charge_type']==2?"selected ":""); ?> value="2">Deduction</option>
                  </select>
                  <span class="help-block"></span>
                </div>
              </div>
              <div class="col-md-6 controls">
                <div class="form-group control-group form-inline">
                  <label> <?php echo e(translate('Charge Percentage')); ?>

                  </label>
                  <input value="<?php echo e($paypalConfig['charge_percentage']); ?>" class="form-control input-full" id="charge_percentage" placeholder="%" name="charge_percentage" />
                  <span class="help-block"></span>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 controls">
                <div class="form-group control-group form-inline">
                  <label class="switch">
                    <input id="sandbox" name="sandbox" type="checkbox" value="1" <?php echo e($paypalConfig['sandbox']==1?"checked":""); ?> class="rm-slider" />
                    <span class="slider round"></span>
                  </label>
                  <label class="pt-1 ml-1">
                    <h5><?php echo e(translate('Enable Sandbox')); ?></h5>
                  </label>
                </div>
              </div>
            </div>
    ...
    <div class="col-md-6">
      <div class="card">
        <div class="card-header">
          <h2><i class="fab fa-cc-stripe"></i> <?php echo e(translate('Stripe Config')); ?></h2>
        </div>
        <form class="form-horizontal" id="inputFormStripeConfig" novalidate="novalidate">
          <div class="card-body">
            ...
            <div class="form-group control-group form-inline">
              <label class="switch">
                <input id="enableStripePayment" <?php echo e($paymentConfig['stripe_payment_status']==1?"checked":""); ?> name="enableStripePayment" type="checkbox" value="1" class="rm-slider" />
                <span class="slider round"></span>
              </label>
              <label class="pt-1 ml-1">
                <h5><?php echo e(translate('Enable Stripe Payment')); ?></h5>
              </label>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 controls">
                <div class="form-group control-group form-inline">
                  <label> <?php echo e(translate('API Key')); ?>

                    <span class="required-label">*</span>
                  </label>
                  <input type="text" value="<?php echo e($stripeConfig!==null?$stripeConfig['api_key']:''); ?>" id="api_key" name="api_key" placeholder="<?php echo e(translate('API Key')); ?>" required class="form-control input-full" data-validation-required-message="Stripe API Key is required" />
                  <span class="help-block"></span>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 controls">
                <div class="form-group control-group form-inline">
                  <label> <?php echo e(translate('API Secret')); ?>

                    <span class="required-label">*</span>
                  </label>
                  <input type="text" value="<?php echo e($stripeConfig!==null?$stripeConfig['api_secret']:''); ?>" id="api_secret" name="api_secret" placeholder="<?php echo e(translate('API Secret')); ?>" required class="form-control input-full" data-validation-required-message="API Secret is required" />
                  <span class="help-block"></span>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 controls">
                <div class="form-group control-group form-inline">
                  ...
                  <select class="form-control input-full" id="charge_type" name="charge_type">
                    <option <?php echo e($stripeConfig!=null?($stripeConfig['charge_type']==1?"selected ":""):''); ?> value="1">Addition</option>
                    <option <?php echo e($stripeConfig!=null?($stripeConfig['charge_type']==2?"selected ":""):''); ?> value="2">Deduction</option>
                  </select>
                  <span class="help-block"></span>
                </div>
              </div>
              <div class="col-md-6 controls">
                <div class="form-group control-group form-inline">
                  ...
                  <input value="<?php echo e($stripeConfig!=null?$stripeConfig['charge_percentage']:''); ?>" class="form-control input-full" id="charge_percentage" placeholder="%" name="charge_percentage" />
                  <span class="help-block"></span>
                </div>
              </div>
            </div>
  ...
  <input type="hidden" id="storedCurrencyValue" value="<?php echo e($paymentConfig['currency']); ?>" />
  <input type="hidden" id="storedChargeType" value="<?php echo e($paypalConfig->charge_type); ?>" />
</div>
<script src="<?php echo e(dsAsset('js/custom/payment/payment-config.js')); ?>"></script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/link/lp/vet/resources/views/payment/payment-config.blade.php ENDPATH**/ ?>